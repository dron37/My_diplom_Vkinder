...
2. Запустите файл create_DB.py для создания базы данных и таблиц,
3. Запустите файл main.py для дальнейшей работы программы-бота.
4. Взаимодействие с пользователем начинается после первого сообщения в чате бота ВК.
