...
from create_DB import Session, DatingUser, MatchingUser, Photos, BlacklistedUser, database_check
from config import vk_token, search_token
...
class VKinderBot:
    ...
    def vkinder_init_command(self, event):
        ...
        print('Проверка данных о пользователе в базе...')
        if len(user) == 0:
